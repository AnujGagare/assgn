...
void inorder( Node* root)
{
	...
	while (ptr != NULL) {
		cout << ptr->info <<" lbit: "<<ptr->lthread<<" rbit: "<< ptr->rthread<<endl;
		ptr = insucc(ptr);
	}
}


Node* inPred(struct Node* ptr)
{
	if (ptr->lthread == true)
		return ptr->left;
...
Node* caseA(struct Node* root, struct Node* par,
				struct Node* ptr)
{
...
// Here 'par' is pointer to parent Node and 'ptr' is
// pointer to current Node.
Node* caseB(struct Node* root, struct Node* par,
				struct Node* ptr)
{
	struct Node* child;
...
// Here 'par' is pointer to parent Node and 'ptr' is
// pointer to current Node.
Node* caseC(struct Node* root, struct Node* par,
				struct Node* ptr)
{
...
Node* delThreadedBST(struct Node* root, int dkey)
{
